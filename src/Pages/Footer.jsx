				...
				<div class="md:flex md:justify-between">
					<div class="mb-6 md:mb-0">
						<a href="#" class="flex items-center">
							<img
								src="https://i.ibb.co/1snLBbF/profil-kelas.jpg"
								alt=""
								className="h-[4.5rem] w-[4.5rem] right-2 relative rounded-full brightness-80"
							/>
					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							<h2 class="mb-4 text-sm font-semibold uppercase text-white">CREATED / REDESIGN BY</h2>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/classical_class01/" class="hover:underline ">
										Instagram
									</a>
								</li>
								<li>
