...
const Schedule = () => {
  ...
  if (currentWeek === 2 || currentWeek === 4) {
    piketGroup = [
      ["Adinda", "Ardiansah", "Kristian", "Nur reza", "Reisha", "Petra", "Aziz"],
      ["Rachma", "Kayla", "Pandu", "Tiara", "Rashif", "Riski"],
      ["Alya", "Adventus", "Asliani", "Rafael", "Afrizal", "Kipra", "Amanda"],
      ["Rachel", "Ramzi", "Heidi", "Meliana", "Hafidzal", "Faiz"],
      ["Diki", "Arya", "Raihan", "Mita", "Salsabila", "Nindya"],
    ];
